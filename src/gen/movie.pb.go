...
const file_movie_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x01 \x01(\v2\t.MetadataR\bmetadata\"\x8c\x01\n" +
	...
	"\frating_value\x18\x01 \x01(\x01R\vratingValue\"3\n" +
...
var file_movie_proto_goTypes = []any{
	...
	(*PutRatingRequest)(nil),            // 4: PutRatingRequest
	(*PutRatingResponse)(nil),           // 5: PutRatingResponse
...
var file_movie_proto_depIdxs = []int32{
	...
	6, // 4: RatingService.GetAggregatedRating:input_type -> GetAggregatedRatingRequest
	4, // 5: RatingService.PutRating:input_type -> PutRatingRequest
	...
	7, // 8: RatingService.GetAggregatedRating:output_type -> GetAggregatedRatingResponse
	5, // 9: RatingService.PutRating:output_type -> PutRatingResponse
